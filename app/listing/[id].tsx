    ...
    return (
        <>
                    ...
                    <View style={styles.contentWrapper}>
                        ...
                        <View style={styles.highlightWrapper}>
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <View>
                                    <Text style={styles.highlightTxt}>Duração</Text>
                                    <Text style={styles.highlightTxtVal}>
                                        {listing.duration} Dias
                                    </Text>
                                </View>
                            </View>
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <View>
                                    <Text style={styles.highlightTxt}>Pessoas</Text>
                            ...
                            <View style={{ flexDirection: "row" }}>
                                ...
                                <View>
                                    <Text style={styles.highlightTxt}>Avaliação</Text>
            ...
            <Animated.View style={styles.footer} entering={SlideInDown.delay(200)}>
                ...
                >
                    <Text style={styles.footerBtnTxt}>Reserve agora</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => { }} style={styles.footerBtn}>
                    <Text style={styles.footerBtnTxt}>R${listing.price}</Text>
                </TouchableOpacity>
            </Animated.View>
        </>
    );
